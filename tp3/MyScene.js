...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.materialWood.setAmbient(0.71, 0.4, 0.26, 1.0);
        this.materialWood.setDiffuse(0.71, 0.4, 0.26, 1.0);
        this.materialWood.setSpecular(0.2, 0.2, 0.2, 1.0);
